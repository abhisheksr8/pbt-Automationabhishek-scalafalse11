package io.prophecy.pipelines.automationabhishekpbtnoscalafalse11

import io.prophecy.libs._
import io.prophecy.pipelines.automationabhishekpbtnoscalafalse11.config._
...
import io.prophecy.pipelines.automationabhishekpbtnoscalafalse11.graph._
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/AutomationabhishekPBTNo-scalafalse11"
    )
